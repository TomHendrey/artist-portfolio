    ...
    return (
        <div className="pt-16 min-h-screen bg-white">
            ...
            <div className="py-4 px-4 max-w-[1400px] mx-auto pb-32">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-22 md:gap-y-46">
                            ...
                            <Link href={`/works/${artwork.slug}`} className="block">
                                <div className="relative aspect-[4/5] mb-4 overflow-hidden bg-neutral-100">
                                    <Image
                                        ...
                                        alt={artwork.title}
                                        fill
                                        className="object-cover group-hover:scale-[1.0] transition-transform duration-500"
